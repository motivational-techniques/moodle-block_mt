...
/**
 * This is the settings page for the quiz grade
 *
 * @package block_mt
...
/**
 * mt_goals class for quiz grade form
 * @author phil.lachance
 * @copyright 2019
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 *
 */
class mt_goals_quiz_grade_form extends moodleform {
    /**
     * defintions
     */
    public function definition() {
        ...
        $mform->addElement ( 'text', 'goal', get_string ( 'mt_goals:quiz_grade_goal', 'block_mt' ) );
