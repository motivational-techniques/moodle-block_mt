...
/**
 * This displays the goals for the course progress
 *
 * @package block_mt
...
$pagename = get_string ( 'mt_goals:course_progress_page_name', 'block_mt' );
$pageurl = '/blocks/mt/mt_goals/course/course_progress.php';
...
require($CFG->dirroot . '/blocks/mt/mt_goals/course/get_course_progress_data.php');

global $DB, $OUTPUT, $PAGE;

echo $OUTPUT->heading ( get_string ( 'mt_goals:course_progress_page_name', 'block_mt' ), 2, 'description', 'uniqueid' );
