...
$counts->silver = get_awards_settings('mt_awards:read_posts_silver_count_value', $courseid);
$counts->bronze = get_awards_settings('mt_awards:read_posts_bronze_count_value', $courseid);
