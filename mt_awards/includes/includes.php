...
/**
 * This is the includes for all pages.
 *
 * @package block_mt
...
$title = get_string ( 'mt_awards:page_title', 'block_mt', $userinformation );
...
if (isset ( $logmtpage )) {
    if ($logmtpage) {
        ...
        $event = \block_mt\event\mt_awards_viewed::create
...
require_once($CFG->dirroot . '/blocks/mt/mt_awards/includes/display_anonymous.php');
require_once($CFG->dirroot . '/blocks/mt/mt_awards/includes/get_current_award.php');
