...
function block_mt_get_rank_name($param) {
    ...
    switch ($param->rank_type_id) {
        case '1':
            $rankname = format_rank_name(get_string('mt_rankings:rank_name_grades', 'block_mt'), $param->rankname);
            break;
        case '3':
            $rankname = get_string('mt_rankings:rank_name_online_time', 'block_mt');
            $rankname = determine_overall_or_period_rankname($param, $rankname, 'rank');
            break;
        case '4':
        ...
        case '7':
            ...
            if ($param->period_type == RANK_PERIOD_OVERALL) {
                $rankname = format_rank_name($rankname, get_string('mt_rankings:rank_name_overall', 'block_mt'));
            } else {
                ...
                $rankname = format_rank_name($rankname, $milestonename);
            }
            break;
        case '10':
